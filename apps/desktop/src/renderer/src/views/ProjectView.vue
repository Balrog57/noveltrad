...
async function importFile() {
  const result = await window.novelTradAPI.invoke<OpenDialogResult>('dialog:open-file', {
...
<template>
  <div v-if="project" class="project">
    ...
    <div class="actions">
      ...
      <button class="btn-primary" :disabled="starting || workflowStore.loading" @click="translate">
