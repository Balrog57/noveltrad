import type { WorkflowStage, AgentInput, AgentOutput } from '@shared/types/index.js'
...
export class AgentFactory {
  ...
  create(stage: WorkflowStage, config: AgentConfig): Agent {
    switch (stage) {
      ...
      case 'translate':
        return new TranslateAgent(config, this.services.aiRouter, this.services.tmEngine)
      case 'consistency':
      ...
      case 'qa':
        return new QaAgent(config, this.services.aiRouter, this.services.qualityChecker)
      case 'export':
