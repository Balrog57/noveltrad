...
field, which can leak filesystem paths or other internals to API clients.
"""
...
def test_upload_hides_security_error_details(security_client):
    secret = "Path traversal attempt detected at /secret/uploads"
