import{_ as a,o as n,c as i,a2 as t}from"./chunks/framework.DpRDjl8b.js";const c=JSON.parse('{"title":"Diagramme d’architecture globale","description":"","frontmatter":{},"headers":[],"relativePath":"assets/diagrams/architecture.md","filePath":"assets/diagrams/architecture.md","lastUpdated":1784327447000}'),e={name:"assets/diagrams/architecture.md"};function l(p,s,E,h,r,k){return n(),i("div",null,[...s[0]||(s[0]=[t(`<h1 id="diagramme-d-architecture-globale" tabindex="-1">Diagramme d’architecture globale <a class="header-anchor" href="#diagramme-d-architecture-globale" aria-label="Permalink to &quot;Diagramme d’architecture globale&quot;">​</a></h1><div class="language-mermaid vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mermaid</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">flowchart TB</span></span>
