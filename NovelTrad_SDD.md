...
| EF-004 | `UT-EF-004` valide GFM et WebP lossless | `IT-EF-004` convertit texte et images | `FT-EF-004` importe un document illustré | `source.md` GFM et WebP lossless valides |
