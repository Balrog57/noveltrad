...
class AnthropicProvider(LLMProvider):
    ...
    def __init__(self, api_key: Union[str, List[str]], model: str = FALLBACK_MODELS[0], api_endpoint: Optional[str] = None):
    ...
    async def generate(self, prompt: str, timeout: int = REQUEST_TIMEOUT, system_prompt: Optional[str] = None) -> Optional[LLMResponse]:
        ...
        while attempt < MAX_TRANSLATION_ATTEMPTS:
            ...
            try:
                ...
                return LLMResponse(content=content, prompt_tokens=prompt_tokens, completion_tokens=completion_tokens, context_used=prompt_tokens + completion_tokens, context_limit=200000)
