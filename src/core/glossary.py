...
def _parse_delimited(text: str, delimiter: str) -> dict[str, str]:
    ...
    # Performance Optimization: use a single-pass iterator instead of list comprehension
    # to maintain O(1) memory complexity for unbounded or large CSV/TSV parsing.
