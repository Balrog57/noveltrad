...
class StageWidget(QFrame):
    ...
    def __init__(self, stage_id: str, label: str) -> None:
        ...
        configure(
            self.expand_btn,
            accessible_name=f"Réduire {self._base_label}",
            tooltip=f"Réduire {self._base_label}"
        )
    ...
    def _on_toggle(self, checked: bool) -> None:
        ...
        configure(
            self.expand_btn,
            accessible_name=f"{action} {self._base_label}",
            tooltip=f"{action} {self._base_label}"
        )
