...
class ToolsPanel(QFrame):
    ...
    def init_ui(self):
        ...
        self.main_window.dict_input.returnPressed.connect(self.main_window.search_dictionary)
        ...
        self.main_window.conc_input.returnPressed.connect(self.main_window.search_concordancer)
