...
class ProjectsTab(QWidget):
    ...
    def refresh(self) -> None:
        ...
        for row, proj in enumerate(items):
            ...
            configure(rename_btn, name=self.tr("Rename {item_name}").format(item_name=name), tooltip=self.tr("Renommer"))
            ...
            configure(del_btn, name=self.tr("Delete {item_name}").format(item_name=name), tooltip=self.tr("Supprimer"))
