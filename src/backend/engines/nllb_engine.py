...
class NLLBEngine:
    ...
    def _translate_multiblock(
        ...
        # Batch encode with SentencePiece natively
        ...
        # Batch decode with SentencePiece natively
        translated_batch = self._sp_target.decode(batch_out_tokens)  # type: ignore[union-attr]
    ...
    def translate_batch(
        ...
        with self._lock:
            try:
                ...
                tokens_batch = self._sp.encode([t.strip() for t in non_empty_texts], out_type=str)  # type: ignore[union-attr]
                ...
                decoded_results = self._sp_target.decode(batch_out_tokens)  # type: ignore[union-attr]
            except Exception as exc:
