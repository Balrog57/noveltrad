...
class NLLBEngine:
    ...
    def _translate_multiblock(
        ...
        # Optimize by batch encoding natively via sentencepiece
        ...
        # Collect and batch decode all output tokens natively via sentencepiece
        out_tokens_batch = []
        for res in results:
    ...
    def translate_batch(
        ...
        with self._lock:
            try:
                ...
                # Tokenize all non-empty texts natively via sentencepiece
                ...
                # Collect and decode all output tokens natively via sentencepiece
                out_tokens_batch = []
                for res in results:
                    out_tokens = res.hypotheses[0]
                    # Strip the language token at the start
